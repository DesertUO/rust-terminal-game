...
fn render_game(game: &Game, stdout: &mut BufWriter<std::io::Stdout>, count_tmp: &f32) -> Result<bool, String> {
    ...
    let title = format!(" counter {} ", count_tmp.to_string());
